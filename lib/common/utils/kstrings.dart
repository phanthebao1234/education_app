class AppText {
  static const String kWellcome = 'Welcome';
  ...
  static const String kAppTerms =
      'Our comprehensive Terms & Conditions document serves as the foundation for using our education_app app. It outlines the legal framework governing your interaction with our platform and its services. This document details important aspects like user conduct, payment terms, intellectual property rights, limitations of liability, and dispute resolution procedures. By using our app, you agree to these terms.  Therefore, we strongly encourage you to take the time to review them thoroughly.  For your convenience, we have made the Terms & Conditions easily accessible within the app.  This ensures you have a clear understanding of your rights and responsibilities as a user promoting a smooth and enjoyable shopping experience for you. Our comprehensive Terms & Conditions document serves as the foundation for using our education_app app. It outlines the legal framework governing your interaction with our platform and its services. This document details important aspects like user conduct, payment terms, intellectual property rights, limitations of liability, and dispute resolution procedures. By using our app, you agree to these terms.  Therefore, we strongly encourage you to take the time to review them thoroughly.  For your convenience, we have made the Terms & Conditions easily accessible within the app.  This ensures you have a clear understanding of your rights and responsibilities as a user promoting a smooth and enjoyable shopping experience for you';
  ...
  static const String kWelcomeHeader =
      'The education_app App That \nMakes You Look You Best';
  static const String kWelcomeMessage =
      "Welcome to education_app app! Discover trends, shop favorite styles, and elevate your wardrobe. Let's get started ";
  static const String kOnboardWishList =
      'Wishlist: Where education_app \nDream Begin';
  ...
  static const String kOnboardHome =
      "Welcome to the ultimate education_app destination! Discover trends, shop your favorite styles, and elevate your wardrobe. Let's get started on your stylish journey today";
  ...
  static const String termOfUsingThisApplication =
      'Terms Of Using this applications';
  static const String haveYouReadySignIn = 'Have you Ready? Sign In';
}
